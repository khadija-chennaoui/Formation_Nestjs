...
export class UpdateEntities1699371403897 implements MigrationInterface {
    name = 'UpdateEntities1699371403897'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "task" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "date_debut" TIMESTAMP NOT NULL, "date_dechaence" TIMESTAMP NOT NULL, "status" "public"."task_status_enum" NOT NULL DEFAULT 'TO_DO', "priority" "public"."task_priority_enum", "userId" integer, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
